                        ...
                        <div class="card">
                            <div class="table-responsive">
                                <table class="table table-hover table-striped table-vcenter mb-0 text-nowrap">
                                    ...
                                    $get_products = "select * from inquiry";
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?=$iid?></td>
                                            <td><span><a href="info?id=<?=$iid ?>"><?=$iname?></a></span></td>
                                            <td><span><?=$iemail?></span></td>
                                            <td><span><?=$isubject?></span></td>
                                            <td><span><?=$idate?></span></td>
                                        </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
