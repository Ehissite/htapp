                                    ...
                                    <table class="table table-hover table-striped text-nowrap table-vcenter mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><?=$uemail?></td>
                                                <td><?=$ustate?></td>
                                                <?php if($subscriber == "Yes"):?>
                                                <td><span class="tag tag-success" style="background-color:green;">Subscriber</span></td>
                                                <?php else: ?>
                                                <td><span class="tag tag-danger" style="background-color:red;">Non Subscriber</span></td>
                                                <?php endif; ?>
                                            </tr>
