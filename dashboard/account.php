                    ...
                    <div class="col-lg-12">
                        <div class="d-lg-flex justify-content-between">
                            <ul class="nav nav-tabs page-header-tab">
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#User_Settings">Account Information</a></li>
                ...
                <div class="row clearfix">
                    <div class="col-md-12">
                        <div class="tab-content">
                            <div class="tab-pane active show" id="User_Settings">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        if (isset($_POST['editPassword']))
                                        {
                                            ...
                                            if ($newpassword == $cnewpassword) {
                                                $sql = "update user set password='$newpassword', passcode='$passcode' where userid='$user_id'"; 
                                                $result = $conn->query($sql); 
                                                if ($result) {
                                                    echo "
                                                    <script>
